...
### 1 & 2. Data Loading & Core Matrices Setup
...
### 7. Debt Spike & Anomaly Detection
...
### 13. Activity & Variation Features
...
### 15. Pay Status Reversal Features
...
* **Permutation Entropy:** Calculates the time-series complexity of a user's payment history using sliding windows of size 3. Note: In dynamical systems, entropy typically requires large time-series datasets to converge. Because we only have 6 months of data, this feature acts as a local complexity heuristic rather than a true systemic entropy measure.